    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('admin.faliyetrapor.store')}}" method="post" autocomplete="off"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">Faliyet Raporu (PDF)</label>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input required type="file" name="pdf" accept="application/pdf" class="custom-file-input"
                                          >
