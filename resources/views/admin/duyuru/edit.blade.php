    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{route('admin.duyuru.update',$duyuru)}}" method="post" autocomplete="off"
                    ...
                    <div class="card-body">
                        @if($duyuru->image)
                            <div class="form-group">
                                ...
                                <div id="file"> <img src="{{asset("storage/images/duyuru_images/$duyuru->image")}}" width="300"  alt="..."></div>
                            </div>
                        @endif
