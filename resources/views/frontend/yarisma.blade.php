<x-front-app>
    ...
    <main class="detail">
        <div class="position-relative mb-4">
            ...
            <div class="container">
                <div class="bread"><h1 class="text-white">Yarışmalar</h1></div>
            </div>
        </div>
        <div class="container">
            <div class="row">
        ...
        <div class="container mb-5">
            ...
            <div class="row">
                <div class="col-12">
                    <img src="{{asset('assets/images/yarismalar.png')}}" alt="..." class="img-fluid mb-4" />
                    ...
                    <a href="#" class="text-decoration-none text-light d-flex justify-content-between bg-red p-3 text-light w-100">
                        <div class="d-flex  align-items-center">
                            ...
                            <h4 class="m-0">
                                İMMİB Endüstriyel Tasarım <br />
                                Yarışmaları Websitesi
                            </h4>
                        </div>
