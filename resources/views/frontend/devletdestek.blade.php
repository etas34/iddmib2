<x-front-app>
    ...
    <main class="detail">
        ...
        <div class="container mb-5">
            <div class="row mb-4">
                <div class="col-12">
                    <h3 class="text-danger font-weight-bold">T.C. Ekonomi Bakanlığ <br />
                        Kolay Destek Websitesi
                    </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <img src="{{asset('assets/images/destekbg.svg')}}" alt="..." class="img-fluid mb-4" />
