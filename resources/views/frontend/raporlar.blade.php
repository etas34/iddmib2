<x-front-app>
    ...
    <main class="detail">
        <div class="position-relative mb-4">
            ...
            <div class="container">
                <div class="bread"><h1 class="text-white">Faaliyet Raporları</h1></div>
            </div>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="position-relative">
                        ...
                        <a target="_blank" href="{{asset("storage/files/faliyetrapor_files/$fr_first->rapor")}}"
                           ...
                           style="bottom:0;">
                            <div class="d-flex  align-items-center">
                                ...
                                <h4 class="m-0"> {{ $fr_first->aciklama }}
                                </h4>
                            </div>
                ...
                @foreach($fr as $key=>$value)
                    @if($value  != $fr_first )
                        <div class="col-12 mb-3">
                            <a href="{{asset("storage/files/faliyetrapor_files/$value->rapor")}}"
